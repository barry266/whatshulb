...
class UploadsController extends AppController {
    ...
    protected function get_download_url($file_name, $version = null, $emptyUserID = false) {
    ...
    protected function is_valid_file_object($file_name, $normal = true) {
    	if ($normal)
        	$file_path = $this->get_upload_path($file_name);
		else
			$file_path = $this->get_session_path($file_name);
		//echo $file_path;exit;
    ...
    protected function validate_file($uploaded_file, $file, $error, $index) {
        if ($error) {
	...
	*/
    ...
    public function get($print_response = true,$id = null) {
