<div class="container">
	<h2>
		<?php echo __('Order Manager: Order (Add)'); ?>
	</h2>
	<div class="row-fluid show-grid" id="tab_user_manager">
		<div class="span12">
			<ul class="nav nav-tabs">
				<?php if ($this->Acl->check('Orders','index','Order') == true){?>
					<li class="active"><?php echo $this->Html->link(__('Order'), array('plugin' => 'order','controller' => 'orders','action' => 'index')); ?></li>
				<?php }?>
			</ul>
		</div>
	</div>
