	...
	<div class="row">
		...
		<div class="span4 well" style="margin: 0 auto !important; float: initial;">
			...
			<div class="control-group">
              ...
              <div class="controls">
                <?php echo $this->Form->input('phone',array('div' => false,'label'=>false,'placeholder'=>__('Phone number'),'error'=>false,'class' => 'span4')); ?>
              </div>
            </div>
						<div class="control-group">
              ...
              <div class="controls">
								<select name="data[User][country]" class="form-control" id="nationality">
