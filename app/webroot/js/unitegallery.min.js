...
function UGTileDesign() {
	...
	function n(e, t) {
		...
		if (B.tile_enable_icons) {
			if (0 == B.tile_as_link && 1 == B.tile_enable_action && 1 == B.tile_show_zoom_icon) {
			...
			if (t.link && 1 == B.tile_show_link_icon || 1 == B.tile_as_link)
				if (0 == B.tile_as_link) {
					var u = "";
					1 == B.tile_link_newpage && (u = " target='_self'"), s += "<a href='" + t.link + "'" + u + " class='ug-tile-icon ug-icon-link'></a>"
...
function UGTextPanel() {
	...
	this.positionElements = function(t) {
		...
		1 == v.textpanel_enable_bg && (i += "<div class='ug-textpanel-bg" + t + "'></div>"), i += "<div class='ug-textpanel-textwrapper" + t + "'>", 1 == v.textpanel_enable_title && (i += "<div class='ug-textpanel-title text-center" + t + "'></div>"), 1 == v.textpanel_enable_description && (i += "<div class='ug-textpanel-description" + t + "'></div>"), i += "</div></div>", e.append(i), l = e.children(".ug-textpanel"), c = l.children(".ug-textpanel-textwrapper"), o()
	}, this.destroy = function() {
